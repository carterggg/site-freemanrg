...
<!-- Website Content -->
 ...
 <!-- Mobile header -->
  <div class="row hidden-sm hidden-md hidden-lg">
  		<div class="col-xs-12">
  		  <br>
  			<a href="index.html" title="Freeman Realty Group"><img src="images/layout/logo2.png" alt="Freeman Realty Group" class="img-responsive align-center" width="350px"></a>
  		</div>
  		<div class="col-xs-6">
  		  <br><br>
  			<img src="images/layout/logo_corresidential.gif" alt="Freeman Realty Group" class="img-responsive align-center" width="420px">
  		</div>
  		<div class="col-xs-6">
  			<img src="images/layout/heroes-logo2.jpg" alt="Freeman Realty Group" class="img-responsive align-center" width="450px">
  		</div>
   ...
   <div class="row hidden-xs">
    	<div class="hidden-xs col-sm-1"></div> 
			<div class="col-xs-12 col-sm-4">
  			  <br>
   				<a href="index.html" title="Freeman Realty Group"><img src="images/layout/logo2.png" alt="Freeman Realty Group" class="img-responsive align-center" width="400px"></a>
   			</div>
  			<div class="col-xs-12 col-sm-4">
  			  <br><br>
	   			<img src="images/layout/logo_corresidential.gif" alt="Freeman Realty Group" class="img-responsive align-center" width="420px">
