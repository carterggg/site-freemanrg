    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-xs-12 col-md-6">
                    <img class="img-responsive hidden-xs hidden-sm align-center" src="images/layout/homesforheroes-tagline.jpg" alt="Freeman Realty Group" width="400px">

                </div>
                <div class="clearfix"></div>
                		<div class="row hidden-md hidden-lg">
                			<div class="col-xs-12 col-sm-6">
                				<img class="img-responsive align-center" src="images/layout/homesforheroes-tagline.jpg" alt="Freeman Realty Group">
                			</div>
                			<div class="col-xs-12 col-sm-6">
               					
                					<br class="hidden-xs hidden-md hidden-lg"><br class="hidden-xs hidden-md hidden-lg">
                				<img src="images/layout/grouppic.jpg" alt="Homes For Heroes" class="img-responsive align-center">
                			</div>                			
                		</div>
		 ...
		 <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                 	<img src="images/layout/grouppic.jpg" alt="Homes For Heroes" class="img-responsive align-center hidden-xs hidden-sm" width="400px">
